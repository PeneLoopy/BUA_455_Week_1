...
- The **[Syllabus](https://docs.google.com/document/d/17GSp0boFPOlwEDTy-MmDIk87md15crge/edit?usp=sharing&ouid=105789079702095490344&rtpof=true&sd=true)** is available as a Google Doc link on Blackboard.
...
- Pre-class Information Videos are available in a [playlist on videos.syr.edu](https://video.syr.edu/playlist/dedicated/269073812/1_p7ywds2n/)
  - Link to these videos is also on Blackboard under **R / R Studio BUA 455 Demo Videos**
...
### Week 1 In-class Exercises (PS L1 - Q1)

***PointSolutions Session ID: bua455s22          (Question 6 of HW 1 - Part 1)***
...
- **When a new version is released:**  Uninstall the old version and download and install the new version of R ASAP. [Video Tutorial](https://video.syr.edu/media/t/1_kr0ogl1i)

- Code to see all R versions and version names: `rversions::r_versions()`
...
- **[Instructions for HW 1 - Parts 2 & 3](https://blackboard.syracuse.edu/webapps/blackboard/content/listContentEditable.jsp?content_id=_8620832_1&course_id=_485886_1)** are on blackboard in the HW Assignment 1 Folder (click on link).
...
**You may submit an 'Engagement Questions about each lecture until midnight on the day of the lecture. A minimum of four submissions are required during the semester.**
]
