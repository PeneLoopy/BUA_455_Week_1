...
### Wk 1 In-class Exercises (TP L1 - Q1)
...
See provided **[tutorial videos]()**, if you need to update your version of R or RStudio.

***NOTE: R updates to a new version two or three times a year. When a new version is available, you should delete the old version and download and install the new version of R as soon as possilbe.***

---

### HW 1 - Parts 2 and 3

- Will be introduced today and covered in depth on Thursday
...
- The [HW 1 - Parts 2 and 3 instructions]() are on blackboard (click on link).. 

---

### R Project Anatomy for BUA 455

- All Lectures, Assignments and student project work will be contained in R project directories

- Project structure can be complex

- In this course, we will keep it simple

#### Outer Project Folder contains:

- **.Rproj** file

  - This file is required and makes the folder an R project.
  
  - You can click on this file to open RStudio, and the Project
...
.middle[![input box for creating a new R project](index_files/images/naming_new_project.png)]
...
![add folder button in RStudio file pane](index_files/images/add_folder.png)

<br>

![naming a new folder code_data_output](index_files/images/cdo.png)
...
![R markdown file creation](index_files/images/new_R_Markdown_file.png)
...
3. Name this file **`HW1_FirstName_LastName`** (with **NO SPACES** in the name)
    ...
    ![saving a Markdown file](index_files/images/markdown_file_name.png)

4. Make sure it is saved to your code_data_output folder.

5. Click the Knit button to render the Markdown file and examine it.   ![Knit button in RStudio](index_files/images/knit_button.png)

---

.panelset[

.panel[.panel-name[Edit the `setup` R Chunk (Chunk 1)]
...
1. Replace the R code in the setup chunk in your file with the R code provided.
   ...
   - Change this to `include=TRUE` so that your setup chunk will appear in the document if you knit it.
      ...
      - In this class, we want to see the R code.
      
2. Run this chunk by clicking green triangle: ![green R chunk triangle](index_files/images/rmd_chunk1_buttons.png)
...
.panel[.panel-name[R code for setup chunk]
...
- If your software is up to date, then come to Zoom clinic this Friday.
...
1. Click Outline button in upper right corner of pane: 
   ...
   ![Markdown outline button](index_files/images/outline_button.png)
...
2. Click navigation bar at bottom: 
   ...
   ![R markdown bottom navigation bar](index_files/images/rmd_bottom_nav_bar.png)
...
- Locations within a dataset can be specifed with square brackets:
    
   - `my_cars[3,2]`:** observation in **3rd row** and **2nd column** of my_cars dataset

   - Additional examples shown below.
  
   - HW 1 includes questions that give you a chance to practice. 
...
- **Factor** variables, `fct` can be created from character variables or numeric variables. 
...
.center[***To save a plot AND print it to the screen, enclose all code in parentheses.***]
